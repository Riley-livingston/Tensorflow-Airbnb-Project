...
Our model has an R² 0.5368 meaning our features can only account for 53.68% of the variation inthe dataset. 
...
<br />
 ...
 <br />
 -Our validation data converges with our training data and reaches an asymptote after about 50 epochs using early stopping callbacks. It appears that the model with our selected features and parameters isnt overfitting or underfitting the dataset and we can use it to generalize or make predictions on listings outside of our dataset. 
 <br />
 ...
 <br /> 
 -Our model seems to systemically underpredict listing prices where the listing is over $350 per night.
 <br/>
 <br/>
