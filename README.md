...
Our model has an R² 0.6532 meaning our features can only account for 65.32% of the variation in price/night. Because we are looking for relatively high percision in predicting prices, Our overall model fit is not ideal.
